#!/usr/bin/env python3
"""
Script para generar tokens JWT para el Appointment Service
"""
import jwt
import datetime
import sys
...
def main():
    print("=== Appointment Service - Token Generator ===\n")
    ...
    print(f"Expira: {datetime.datetime.utcnow() + datetime.timedelta(days=1)}\n")
    print("Token:")
    print(token)
